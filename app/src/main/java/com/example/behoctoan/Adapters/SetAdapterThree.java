...
public class SetAdapterThree extends RecyclerView.Adapter<SetAdapterThree.viewHolder>{

    Context context;
    ArrayList<SetModel> list;

    public SetAdapterThree(Context context, ArrayList<SetModel> list) {
    ...
    public void onBindViewHolder(@NonNull viewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, QuestionActivityThree.class);

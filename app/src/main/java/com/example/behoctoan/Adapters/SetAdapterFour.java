...
import com.example.behoctoan.activities.QuestionFourActivity;
import com.example.behoctoan.activities.QuestionTwoActivity;
import com.example.behoctoan.databinding.ItemSetsBinding;

import java.util.ArrayList;

public class SetAdapterFour extends RecyclerView.Adapter<SetAdapterFour.viewHolder>{

    Context context;
    ArrayList<SetModel> list;

    public SetAdapterFour(Context context, ArrayList<SetModel> list) {
    ...
    public void onBindViewHolder(@NonNull viewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, QuestionFourActivity.class);

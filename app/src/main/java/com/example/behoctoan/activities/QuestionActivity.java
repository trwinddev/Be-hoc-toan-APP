...
public class QuestionActivity extends AppCompatActivity {
    ...
    private void setOne(){
        list.add(new QuestionModel("Số bé nhất trong các số: 8 , 3 , 10 , 6 là:", "A. 3", "B. 8", "C. 6", "D. 10", "A. 3"));

        list.add(new QuestionModel("Số lớn nhất trong các số: 8 , 3 , 10 , 6 là:", "A. 3", "B. 8", "C. 6", "D. 10", "C. 10"));
    }

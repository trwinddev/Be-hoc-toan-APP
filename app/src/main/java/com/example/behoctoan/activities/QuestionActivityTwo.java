...
public class QuestionActivityTwo extends AppCompatActivity {
        ...
        binding.btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(position == list.size()) {
                    Intent intent = new Intent(QuestionActivityTwo.this, ScoreActivity.class);
    ...
    private void resetTimer() {
        timer = new CountDownTimer(30000, 1000) {
            ...
            public void onFinish() {
                Dialog dialog = new Dialog(QuestionActivityTwo.this);
                ...
                dialog.findViewById(R.id.tryAgain).setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent intent = new Intent(QuestionActivityTwo.this, SetsActivity.class);
                        startActivity(intent);
                        finish();
                    }
                });
